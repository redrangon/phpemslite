...
export default {
	...
	methods:{
		getData:async function(){
			await this.execute( async () =>{
				const data = await planApi.getExamHistoryList({
					search:{
						...this.search,
						ehpassport:this.passport,
						ehbasicid:this.basicId
					},
					planId:this.planId,
		...
		examStats:function(){
			this.$router.push('/desktop/master/plan/stats/'+ this.planId + '/' + this.basicid)
		},
		...
		exportScore:async function(){
			...
			const data = await planApi.exportExamHistory({
				search:{
					...this.search,
					ehpassport:this.passport,
					ehbasicid:this.basicId,
