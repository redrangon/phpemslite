<template>
	<div ref="mathContainer">
		<lay-space direction="vertical" class="question" fill wrap>
			<div v-html="question.parent" style="padding:10px 5px 10px 5px;" v-if="question.parent && (childIndex === 0)"></div>
			<div v-html="question.question" style="padding:0 5px 10px 5px;"></div>
			...
			<!-- 填空题 -->
			<template class="selector" v-else-if="questionType.questchoice === 5">
